...
{
    internal class AsteriumHook : ModItem
    {
        public override void SetDefaults()
        {
            ...
            Item.width = 28;
            Item.height = 34;
            Item.shoot = ModContent.ProjectileType<AsteriumHookProjectile>(); // Makes the item shoot the hook's projectile when used.
        }
        ...
        {
            CreateRecipe()
                .AddIngredient(ModContent.ItemType<AsteriumFragment>(), 10)
                .AddTile(TileID.MythrilAnvil)
                .Register();
        }
    }

    internal class AsteriumHookProjectile : ModProjectile
    {
        ...
        { // This is called once on mod (re)load when this piece of content is being loaded.
          // This is the path to the texture that we'll use for the hook's chain. Make sure to update it.
            chainTexture = ModContent.Request<Texture2D>("Alterra/Items/Tools/AsteriumHookChain");
        }
